...
/**
 * Legacy ExprEmitter implementation (pre-address-only refactor).
 */
class ExprEmitterOld(
  ...
  private val blockEmitter by lazy { FunctionEmitter(context, builder, ExprEmitter(context), valueEnv) }
