...
//        is MatchExprNode -> this.dumpToString(indent)
    ...
    is BorrowExprNode -> this.dumpToString(indent)
    is DerefExprNode -> this.dumpToString(indent)
  }
}

fun BorrowExprNode.dumpToString(indent: Int): String {
  val builder = StringBuilder()
  val padding = " ".repeat(indent)
  builder.append("${padding}BorrowExprNode (isMut=$isMut) {\n")
  builder.append(this.expr.dumpToString(indent + 2))
  builder.append("${padding}}\n")
  return builder.toString()
}

fun DerefExprNode.dumpToString(indent: Int): String {
  val builder = StringBuilder()
  val padding = " ".repeat(indent)
  builder.append("${padding}DerefExprNode {\n")
  builder.append(this.expr.dumpToString(indent + 2))
  builder.append("${padding}}\n")
  return builder.toString()
}
...
fun UnaryExprNode.dumpToString(indent: Int): String {
  val builder = StringBuilder()
  val padding = " ".repeat(indent)
  builder.append("${padding}UnaryExprNode (op=${op}) {\n")
